# v0.5.16/A — Yargı Pro teyit izi (hakem)
...
## A'ya özgü hüküm
- Norm atıfları (TCK 22/4-5, 37-39; HMK 190, 353, 370; TBK 19, 52; CMK 280, 302): tümü madde metniyle uyuşuyor.
- Hukuki mantık: `ceza:magdur_kusuru` "illiyeti kesmez, kusur derecesine etki eder" doktrin hatırlatması olarak (hüküm değil) etiketlenmiş; kanun yolu kenarı illiyet hesabına girmiyor (doğru: yargı kademesi neden-sonuç değildir); köprü `perde` etiketi tetik, hüküm değil — uygun.
- Küçük: `sonuc` enumu HMK m.353/1-b-2 "düzelterek yeniden esas hakkında karar" ve CMK m.280/1-a "düzelterek esastan ret" hâllerini ayrı değer olarak taşımıyor (kaldirdi/esastan_ret altında eriyor); doktrin tablosunda not düşülebilir.
- Küçük: "Yargıtay iki yolu alternatif değil, birlikte sayar" cümlesi kütükten künye gelene kadar "yön" iddiası olarak kalıyor — künye eklenirken 11. HD 2024 hattı sorgulanmalı.
