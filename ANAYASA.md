> **VİTRİN NÜSHASI** — bağlayıcı tek kaynak
> [`skills/ortak-avukat/references/anayasa.md`](plugins/ortak-avukat/skills/ortak-avukat/references/anayasa.md)
> dosyasıdır; bir ilke değişecekse önce orada değişir, bu nüsha oradan
> tazelenir (tek-kaynak kuralı). Meslektaş özeti için: [README → DÜSTUR](README.md#düstur--sistemin-anayasası).
...
- **Dış desen devşirme protokolü (ONAYLI — 2026-08-12, karar: Av. Bayram Can
  ...
  MIT/lisans telif satırı korunur ve kendi test dosyasıyla gelir (`aile_dogrula`
  "vendor dosyası testsiz olamaz" diye denetler); pip bağımlılığı ancak
  "minimal + Windows-dostu + eksikte fail-closed" süzgecinden geçerse eklenir.
