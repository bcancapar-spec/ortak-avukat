...
5. KIYAS       → oa-kiyas **MUHAKEME EDER + DAMGALAR**: norm→vakıa→sonuç, unsur
                 ...
                 İLLİYET + **DAMGA** — `oa-kiyas/references/ictihat-muhakeme-
...
9. KONTROL     → oa-kontrol (usul+esas+atıf+illiyet denetimi + MANİFEST kapatma) +
                 ...
                 dahil) koşar; **DÖRT** yeşil ışık (kunye_teyit + ictihat_muhakeme_
                 denetim + dilekce_denetim + defter --denetle) olmadan TESLİM YOK
